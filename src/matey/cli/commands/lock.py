...
def register(lock_app: typer.Typer) -> None:
    @lock_app.command("doctor", help="Check schema.lock.toml and checkpoint integrity.")
    ...
    @lock_app.command("sync", help="Regenerate schema.lock.toml from repo artifacts.")
